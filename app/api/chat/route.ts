...
//
// Everything goes through the Vercel AI SDK's streamText so the client can use
// useChat() and stop() with no custom SSE plumbing.
...
/**
 * Convert the client's `{role, content, images?}` shape into AI SDK CoreMessage.
 * Users with images produce a multi-part content array; the SDK dispatches image
 * parts as base64 blocks to whichever provider is chosen.
 */
