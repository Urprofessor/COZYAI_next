...
/** Rotating text loading indicator — GPT-thinking style opacity swap every 1s. */
    ...
    <div className="flex flex-col self-start items-start max-w-[86%]">
      {isSupport && (
        <div className="flex items-center gap-1.5 mb-1.5">
          ...
          />
          <span className="text-xs font-semibold text-brand-rose-500 opacity-75">Sarah</span>
        </div>
      )}
